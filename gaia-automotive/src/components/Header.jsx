    ...
    return (
        <header style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column' }}>
                <h1 style={{ fontSize: '1.125rem', fontWeight: '600', color: '#111827' }}>Predictive Logic Systems</h1>
                <span style={{ fontSize: '0.75rem', color: '#6b7280' }}>AI-Powered Predictive Maintenance Intelligence</span>
            </div>
